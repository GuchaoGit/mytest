        ...
        switch (v.getId()) {
            ...
            case R.id.btn_glide_show_base64:
                if (TextUtils.isEmpty(picBase64)) {
                    ...
                    Glide.with(getBaseContext()).load(data).into(ivShowBase64);
                }
                break;
        }
    }
