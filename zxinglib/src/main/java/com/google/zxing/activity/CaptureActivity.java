...
public final class CaptureActivity extends Activity implements
    ...
    public static final String KEY_TITLE = "key_title";//扫一扫标题
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!TextUtils.isEmpty(title)) {
            ((TextView) findViewById(R.id.tv_common_header_title)).setText(title);
        }
        hasSurface = false;
        ...
        findViewById(R.id.rl_function_left).setOnClickListener(this);
...
//                Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View v) {
        ...
        } else if (v.getId() == R.id.rl_function_left) {
            this.finish();
        }
